...
pub async fn get_user_id<'a, A: Acquire<'a, Database = Postgres>>(db_conn: A, registration_id: Uuid, _type: ConfirmationCodeType) -> Result<Uuid, GetUserIdFromConfirmationCodeRecordError> {
